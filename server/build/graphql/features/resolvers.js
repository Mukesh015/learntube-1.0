...
const queries = {
    ...
    getNotifications: (_14, _22) => __awaiter(void 0, [_14, _22], void 0, function* (_, { email }) {
        try {
            ...
            const getVideoThumbnailAndCourseDetails = (videoId) => __awaiter(void 0, void 0, void 0, function* () {
                try {
                    const video = yield video_1.VideoModel.findOne({ "courses.videos.videoID": videoId });
                    if (!video) {
                        throw new Error('Video not found');
            ...
            const notifications = yield Promise.all(user.notification.map((notification) => __awaiter(void 0, void 0, void 0, function* () {
                ...
                return {
                    ...
                    videoThumbnail: (yield getVideoThumbnailAndCourseDetails(notification.videoId)).videoThumbnail,
                    corseFees: (yield getVideoThumbnailAndCourseDetails(notification.videoId)).courseFees,
                    courseId: (yield getVideoThumbnailAndCourseDetails(notification.videoId)).courseId,
                    avatar,
                    channelLogo
                };
            })));
