        ...
        >
            ...
            >
                <ul className="space-y-1.5">
                    <li className="transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-150">
                        <button
                            onClick={() => router.push("/")}
                            type="button"
                            className={`hs-accordion-toggle ${isDarkMode ? "hover:bg-gray-300 text-black" : "hover:bg-gray-700 text-white"} hs-accordion-active:text-blue-600 hs-accordion-active:hover:bg-transparent w-full text-start flex items-center gap-x-3.5 py-2 px-2.5 text-medium font-semibold rounded-lg`}
                        >
                            <svg
                ...
                <ul className="space-y-1.5 mt-3">
                    ...
                    >
                        <button
                            ...
                            type="button"
                            className={`hs-accordion-toggle ${isDarkMode ? "hover:bg-gray-300 text-black" : "hover:bg-gray-700 text-white"} hs-accordion-active:text-blue-600 hs-accordion-active:hover:bg-transparent w-full text-start flex items-center gap-x-3.5 py-2 px-2.5 text-medium font-semibold rounded-lg hover:bg-gray-700`}
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                enableBackground="new 0 0 24 24"
                    ...
                    <li className="hs-accordion" id="account-accordion">
                        <button
                            ...
                            type="button"
                            className={`transition ${isDarkMode ? "hover:bg-gray-300 text-black" : "hover:bg-gray-700 text-white"} ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-150 hs-accordion-toggle hs-accordion-active:text-blue-600 hs-accordion-active:hover:bg-transparent w-full text-start flex items-center gap-x-3.5 py-2 px-2.5 text-medium font-semibold rounded-lg`}
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                height="24px"
                    ...
                    <li className="hs-accordion" id="account-accordion">
                        <button
                            ...
                            type="button"
                            className={`transition ease-in-out ${isDarkMode ? "hover:bg-gray-300 text-black" : "hover:bg-gray-700 text-white"} delay-150 hover:-translate-y-1 hover:scale-110 duration-150 hs-accordion-toggle hs-accordion-active:text-blue-600 hs-accordion-active:hover:bg-transparent w-full text-start flex items-center gap-x-3.5 py-2 px-2.5 text-medium font-semibold rounded-lg`}
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                enableBackground="new 0 0 24 24"
                ...
                <ul id="Subscriptions" className="mt-4 space-y-1.5">
                    <li onClick={handleShowSubscriptions} className={`py-2 ${isDarkMode ? "hover:bg-gray-300 text-black" : "hover:bg-gray-700 text-white"} px-2.5 rounded-lg flex ml-3 font-semibold pb-2`}>
                        My Subscriptions
                        {toggleSVG ? (
                            ...
                            <svg className="ml-2 rounded-full" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill={isDarkMode ? '#000000' : '#FFFFFF'}
                            ><path d="M24 0v24H0V0h24z" fill="none" opacity=".87" /><path d="M14 7l-5 5 5 5V7z" /></svg>
                        )}
                ...
                <ul className="mt-4 space-y-1.5">
                    ...
                    >
                        <button
                            ...
                            type="button"
                            className={`hs-accordion-toggle hs-accordion-active:text-blue-600 ${isDarkMode ? "hover:bg-gray-300 text-black" : "hover:bg-gray-700 text-white"} hs-accordion-active:hover:bg-transparent w-full text-start flex items-center gap-x-3.5 py-2 px-2.5 text-medium font-semibold rounded-lg`}
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                height="24px"
