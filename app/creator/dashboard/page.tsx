...
const CardGrid: React.FC = () => {
    ...
    return (
        <>
            <NextTopLoader />
            {loading ? (
                <div className={`w-96 ${isDarkMode ? "bg-white" : "bg-black"} mt-40 ml-[600px]`}>
