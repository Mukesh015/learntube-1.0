...
export default function ForgotPassword() {
    ...
    const handlerSentLinkToEmail = useCallback(async () => {
        if (!email) {
                                        ...
                                        <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                            <div className="relative z-0 w-full mb-5 group">
                                                ...
                                                {showSpinnerLoginButton &&
                                                    <p className="max-w-72 text-slate-500 text-small">A link is sent to your email, click on that link to login your account, link is valid only for 10 mins.</p>
                                                }
                                            ...
                                            <div className="relative">
                                                {!showSpinnerLoginButton ? (
                                                    <button
                                                        onClick={() => handlerSentLinkToEmail()}
